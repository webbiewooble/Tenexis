...
if (startIndex !== -1 && endIndex !== -1) {
    ...
    const after = originalProductsHtml.substring(endIndex);
    ...
    // ensure links are correct for page 2 if needed (it should be same since they're in same folder)
    fs.writeFileSync('products-2.html', products2Html);
    
    console.log("Split products into two pages with pagination.");
} else {
