...
new_product = """
                ...
                <div class="group bg-white rounded-3xl p-8 lg:p-10 shadow-lg shadow-slate-200/40 border border-slate-100 hover:border-medical-200 hover:shadow-2xl hover:shadow-medical-900/10 transition-all duration-500 relative flex flex-col overflow-hidden text-left">
                    ...
                    <div class="relative z-10 flex flex-col h-full">
                        ...
                        <h3 class="text-xl lg:text-2xl font-display font-bold text-slate-900 mb-4 leading-snug group-hover:text-medical-700 transition-colors duration-300">Lateral Closing Distal Femoral Osteotomy (DFO) Plate</h3>
                        
                        <p class="text-base text-slate-600 font-light leading-relaxed mb-8 flex-grow">Anatomically designed lateral closing wedge plate for the distal femur, providing superior stability and precision in correcting complex lower limb deformities and unicompartmental osteoarthritis.</p>
...
# Insert Product 3 after Product 2 in products-6.html
pattern = r'(<!-- Product 2 -->.*?</div>\s*</div>\s*</div>)'
