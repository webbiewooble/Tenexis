...
const products = [
  ...
  { name: "Medial Closing DFO Plate – Right Size 2", desc: "Large right-sided titanium bone plate designed for stable medial closing wedge osteotomy fixation." },
...
if (startIndex !== -1 && endIndex !== -1) {
    ...
    console.log("Updated products without arrow buttons.");
} else {
